...
void buscarReg(FILE *archivoBinario, TIndex *indices, int cantidadRegistros, bool sorted)
{
...
void ordenarVector(TIndex *indices, int cantidadRegistros)
{
...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
            buscarReg(archivoBinario, indices, MAX_REGISTERS, sorted);
            break;

        case 4:
            ordenarVector(indices, MAX_REGISTERS);
            sorted = true;
            break;
